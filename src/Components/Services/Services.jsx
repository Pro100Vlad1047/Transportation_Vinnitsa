    ...
    return (
        <div className={s.Services}>
          ...
          <div className={s.wrapper}>
                <h2>ПОСЛУГИ</h2>
                <span>Ми надаємо послуги вантажників у Києві як окрему послугу,
                    а також додаткову послугу з вантажних перевезень у всіх районах:
                    дарницький (дарниця), святошинський (святошин), Солом'янський (солом'янка),
                    оболонський (оболонь), дніпровський, шевченківський, голосіївський, подільський (поділ),
                    виноградар, троєщина.
